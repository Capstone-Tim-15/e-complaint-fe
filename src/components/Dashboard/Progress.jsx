  ...
  return (
    <div className="d-flex">
      <div className="d-flex flex-column justify-content-between me-4 text-end">
        ...
        <p className="text-secondary small">2 Minggu yang lalu</p>
        <p className="text-secondary small">1 Bulan yang lalu</p>
      </div>
      <div
        style={{ marginRight: "16px" }}
        className="w-8 d-flex flex-column justify-content-between align-items-center"
      >
        <div
          style={{ width: "32px", height: "32px" }}
          className="d-flex align-items-center justify-content-center rounded bg-primary p-2"
        >
          <svg
